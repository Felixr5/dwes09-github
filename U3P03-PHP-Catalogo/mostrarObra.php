...
?>
<?php
if (!isset($_REQUEST["idCanc"])) die ("<h3>ERROR en la petición. Falta identificador de cancion</h3>");
...
if($resultado->num_rows === 0) die ("<h3>ERROR en la petición. Identificador de cancion no válido</h3>");
